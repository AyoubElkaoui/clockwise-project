    ...
    public static class SeedData
    {
        public static void Initialize(ClockwiseDbContext context)
        {
            ...
            var projects = new List<Project>
            {
                ...
                new Project { Name = "2024-100-001 - Renovatie Kantoor", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-002 - Installatie Systeem", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-003 - Verbouwing Pand", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-004 - Onderhoud Gebouw", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-005 - Uitbreiding Faciliteit", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-006 - Modernisering Installatie", ProjectGroupId = projectGroups[0].Id },
                new Project { Name = "2024-100-007 - Herinrichting Ruimte", ProjectGroupId = projectGroups[0].Id },
            ...
            // Stel ManagerId in voor team members
            var manager = users.First(u => u.Rank == "manager");
            var teamMembers = users.Where(u => u.Rank == "user").Take(5).ToList(); // Neem 5 users als team
