...
export default function MotivationCard({
  ...
  return (
    <div className="bg-neutral-900 text-white p-6 rounded-2xl shadow-lg flex flex-col gap-3">
      ...
      <button className="mt-4 bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-xl font-medium">
        Blijf zo doorgaan!
      </button>
    </div>
  );
